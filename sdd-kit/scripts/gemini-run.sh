...
#
# Uso:
#   ./sdd-kit/scripts/gemini-run.sh <caminho-do-prompt>
#   ./sdd-kit/scripts/gemini-run.sh --dry-run <caminho-do-prompt>   (mostra contexto sem executar)
#   ./sdd-kit/scripts/gemini-run.sh --list                          (lista todos os prompts disponíveis)
#   ./sdd-kit/scripts/gemini-run.sh --chain fase2                   (executa todos os prompts de uma fase)
#
# Exemplos:
#   ./sdd-kit/scripts/gemini-run.sh sdd-kit/prompts/features/filme/01-domain.md
#   ./sdd-kit/scripts/gemini-run.sh --dry-run sdd-kit/prompts/features/ingresso/02-application.md
#   ./sdd-kit/scripts/gemini-run.sh --chain scaffolding
# =============================================================================
...
${YELLOW}Uso:${NC}
  ./sdd-kit/scripts/gemini-run.sh <prompt>                    Executa um prompt
  ./sdd-kit/scripts/gemini-run.sh --dry-run <prompt>          Mostra o que seria executado
  ./sdd-kit/scripts/gemini-run.sh --chain <fase>              Executa todos os prompts de uma fase
  ./sdd-kit/scripts/gemini-run.sh --list                      Lista todos os prompts disponíveis
  ./sdd-kit/scripts/gemini-run.sh --help                      Mostra esta ajuda

${YELLOW}Exemplos:${NC}
  ./sdd-kit/scripts/gemini-run.sh sdd-kit/prompts/features/filme/01-domain.md
  ./sdd-kit/scripts/gemini-run.sh --dry-run sdd-kit/prompts/features/ingresso/02-application.md
  ./sdd-kit/scripts/gemini-run.sh --chain scaffolding
  ./sdd-kit/scripts/gemini-run.sh --chain fase2
