...
context:
  ...
  - sdd-kit/docs/features/sessao.md
  - sdd-kit/docs/features/auth.md
---

# Tarefa: Gerar testes unitários para todos os módulos

Gere os arquivos de teste em `src/test/java/com/amenicsystem/`.
Siga estritamente as convenções em `sdd-kit/docs/conventions/testing.md`.
