...
context:
   ...
   - sdd-kit/docs/conventions/testing.md
---
...
Os testes ficam em `src/test/java/com/amenicsystem/`.

## Setup base — AmenicSystemIntegrationTest.java (classe abstrata)

```java
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@Testcontainers
public abstract class AmenicSystemIntegrationTest {
