---
context:
  - sdd-kit/docs/architecture/package-structure.md
  - sdd-kit/docs/architecture/layer-rules.md
---

# Tarefa: Criar estrutura de pacotes e arquivos vazios

Crie todos os pacotes e arquivos Java do projeto AmenicSystem
conforme a estrutura exata definida em `sdd-kit/docs/architecture/package-structure.md`.
