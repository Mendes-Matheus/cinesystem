...
context:
  ...
  - sdd-kit/docs/database/tables.md
...
- Campos espelham EXATAMENTE as colunas da tabela `ingresso` em `sdd-kit/docs/database/tables.md`
...
- Campos espelham EXATAMENTE as colunas da tabela `outbox_events` em `sdd-kit/docs/database/tables.md`
...
- Chave: `"reserva:%d:%d".formatted(sessaoId.id(), assentoId.valor())`
- TTL: 10 minutos
