---
context:
  - sdd-kit/docs/architecture/clean-architecture.md
  - sdd-kit/docs/architecture/layer-rules.md
  - sdd-kit/docs/features/ingresso.md
  - sdd-kit/docs/conventions/patterns.md
---

# Tarefa: Implementar application/ingresso (Outbox Pattern)

Esta é a feature mais crítica do sistema. Leia `sdd-kit/docs/features/ingresso.md`
...
- Campos conforme `sdd-kit/docs/features/ingresso.md`
...
Crie **dois** records conforme `sdd-kit/docs/features/ingresso.md` (seção Results):
...
- Fluxo EXATO de 6 passos definido em `sdd-kit/docs/features/ingresso.md`
