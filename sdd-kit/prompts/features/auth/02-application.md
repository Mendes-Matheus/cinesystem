...
- Fluxo exato da seção "Comportamento de CadastrarUsuarioUseCaseImpl" em `sdd-kit/docs/features/auth.md`
...
- `@Service`
- Injeta: `UsuarioRepository`, `PasswordEncoder`, `JwtPort`
- Fluxo exato da seção "Comportamento de AutenticarUsuarioUseCaseImpl" em `sdd-kit/docs/features/auth.md`
