...
### FilmeResult.java
- `record` com todos os campos listados em `sdd-kit/docs/features/filme.md`
...
### FilmeQueryPort.java
- Interface com os 2 métodos especificados em `sdd-kit/docs/features/filme.md`
- ATENÇÃO: esta porta retorna `FilmeResult` diretamente — nunca `Filme`

## Use Cases — application/filme/usecase/

Implemente os 4 pares interface + impl conforme a tabela em `sdd-kit/docs/features/filme.md`.
