...
conforme especificado em `sdd-kit/docs/features/filme.md`.
...
- Campos conforme `sdd-kit/docs/features/filme.md` (seção Domínio)
...
- Interface com os 4 métodos especificados em `sdd-kit/docs/features/filme.md`
